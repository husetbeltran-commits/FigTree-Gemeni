...
const SearchPage: React.FC = () => {
  ...
  return (
    <div className="animate-fade-in min-h-screen">
      ...
      <div className="sticky top-14 bg-background z-30 p-4 border-b border-white/5 space-y-4">
        {/* Search Input */}
        <div className="relative">
          ...
          <input 
            ...
            className="w-full bg-surface border border-white/10 rounded-full pl-10 pr-4 py-3 text-sm focus:outline-none focus:border-accent text-primary placeholder-secondary/50 transition-all"
            value={query}
      ...
      <div className="p-4 space-y-3">
        {results.length > 0 ? (
          results.map((item: any, idx) => (
            <Link key={idx} to={item.path} className="block bg-surface p-4 rounded-lg border border-white/5 hover:border-white/20">
